...
import { dateStr, isOnGoing, marketFilter, teamLogoUrl } from '@/lib/utils/general';
      ...
      {position.positions.map((pos, index) => {
        ...
        return (
          <div key={index}>
            ...
            <div className="h-line-dotted"></div>
            <div className="bet-info">
              ...
              <div className='bet-info-box'>
                <span>Odds</span>
                <span>
                  {pos.position === 0 && homeOdds ? homeOdds[odds].toFixed(2)
                    : pos.position === 1 && awayOdds ? awayOdds[odds].toFixed(2)
                      : pos.position === 2 && drawOdds ? drawOdds[odds].toFixed(2)
                        : -1
                  }
                </span>
              </div>
